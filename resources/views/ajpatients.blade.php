...
<main id="main" class="main">
  ...
  <section class="section dashboard">
    ...
    <div class="row">
      <form action="{{route('patientst')}}" method="POST" class="form-group">
        @csrf
        ...
        <div class="mb-3 row">
          ...
          <a href="{{route('patients')}}"><button type="button" class="btn btn-danger">VOIR LA LISTE DES PATIENTS</button></a>
      </form>
